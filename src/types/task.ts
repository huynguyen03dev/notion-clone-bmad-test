...
export interface TaskFilters {
  ...
  sortBy?: 'title' | 'priority' | 'dueDate' | 'createdAt' | 'updatedAt' | 'position';
  sortOrder?: 'asc' | 'desc';
  limit?: number;
  offset?: number;
}
...
export interface TaskError {
  code: 'TASK_NOT_FOUND' | 'COLUMN_NOT_FOUND' | 'BOARD_NOT_FOUND' | 'UNAUTHORIZED' | 'VALIDATION_ERROR' | 'POSITION_CONFLICT' | 'INTERNAL_ERROR';
  message: string;
  field?: string;
}
